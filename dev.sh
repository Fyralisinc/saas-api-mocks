...
cmd_serve() {
    ...
    case "$provider" in
        ...
        *) c_red "unknown provider: $provider (use slack|discord|github|gmail|calendar|notion|drive|jira|quickbooks|grafana|mercury|ashby|brex|deel)"; exit 1 ;;
    esac
...
dev.sh — setup + task runner for the Gharelu-Alpen spammer
  ...
  ./dev.sh serve [slack|discord|github|gmail|calendar|notion|drive|jira|quickbooks|grafana|mercury|ashby|brex|deel]
                              ...
                              ashby:7012 brex:7013 deel:7014;
                              \$PORT overrides)
