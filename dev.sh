...
cmd_serve() {
    ...
    case "$provider" in
        ...
        *) c_red "unknown provider: $provider (use slack|discord|github|gmail|calendar|notion|drive|jira|quickbooks|grafana|mercury|ashby|brex|deel|hibob|figma|miro|ramp|gusto)"; exit 1 ;;
    esac
...
dev.sh — setup + task runner for the Gharelu-Alpen spammer
  ...
  ./dev.sh serve [slack|discord|github|gmail|calendar|notion|drive|jira|quickbooks|grafana|mercury|ashby|brex|deel|hibob|figma|miro|ramp|gusto]
                              ...
                              miro:7017 ramp:7018 gusto:7019; \$PORT overrides)
