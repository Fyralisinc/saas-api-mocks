...
cmd_serve() {
    ...
    case "$provider" in
        ...
        signal)   default_port=7025 ;;
        *) c_red "unknown provider: $provider (use slack|discord|github|gmail|calendar|notion|drive|jira|quickbooks|grafana|mercury|ashby|brex|deel|hibob|figma|miro|ramp|gusto|carta|linkedin|fireflies|aws|telegram|signal)"; exit 1 ;;
    esac
...
dev.sh — setup + task runner for the Gharelu-Alpen spammer
  ...
  ./dev.sh serve [slack|discord|github|gmail|calendar|notion|drive|jira|quickbooks|grafana|mercury|ashby|brex|deel|hibob|figma|miro|ramp|gusto|carta|linkedin|fireflies|aws|telegram|signal]
