"""POST /token — Google's DWD token exchange (shared with Gmail/Calendar)."""
...
async def token(request: Request):
    ...
    scope = claims.get("scope") or params.get("scope") or "https://www.googleapis.com/auth/drive.readonly"
